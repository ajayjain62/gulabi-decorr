          ...
          <div className="row g-3">
            ...
            <div className="col-md-4">
              <div className="card">
                {" "}
                <img
                  src="https://i.imgur.com/441QtPc.jpg"
                  className="card-img-top"
                />
                <div className="card-body">
                  <div className="d-flex justify-content-between">
                    ...
                    <span className="font-weight-bold">₹850</span>{" "}
                  </div>
                  <p className="card-text mb-1 mt-1">
                    Some quick example text to build on the card title and make
                    up the bulk of the card's content.
                  ...
                  <div className="d-flex align-items-center flex-row">
                    ...
                    <img
                      ...
                      width={20}
                    />{" "}
                    <span className="guarantee">3 Years Guarantee</span>{" "}
                  </div>
                </div>
                <hr />
                <div className="card-body">
            ...
            <div className="col-md-4">
              <div className="card">
                {" "}
                <img
                  src="https://i.imgur.com/hnX99Cr.jpg"
                  className="card-img-top"
                />
                <div className="card-body">
                  <div className="d-flex justify-content-between">
                    ...
                    <span className="font-weight-bold">₹15,50</span>{" "}
                  </div>
                  <p className="card-text mb-1 mt-1">
                    Some quick example text to build on the card title and make
                    up the bulk of the card's content.
                  ...
                  <div className="d-flex align-items-center flex-row">
                    ...
                    <img
                      ...
                      width={20}
                    />{" "}
                    <span className="guarantee">8 Years Guarantee</span>{" "}
                  </div>
                </div>
                <hr />
                <div className="card-body">
          ...
          <div className="row g-3">
            ...
            <div className="col-md-4">
              <div className="card">
                {" "}
                <img
                  src="https://i.imgur.com/L5iInTA.jpg"
                  className="card-img-top"
                />
                <div className="card-body">
                  <div className="d-flex justify-content-between">
            ...
            <div className="col-md-4">
              <div className="card">
                {" "}
                <img
                  src="https://i.imgur.com/64PRDTx.jpg"
                  className="card-img-top"
                />
                <div className="card-body">
                  <div className="d-flex justify-content-between">
          ...
          <div className="row g-3">
            ...
            <div className="col-md-4">
              <div className="card">
                {" "}
                <img
                  src="https://i.imgur.com/uh0knIW.jpg"
                  className="card-img-top"
                />
                <div className="card-body">
                  <div className="d-flex justify-content-between">
                    {" "}
                    <span className="font-weight-bold">
                      Dinning table set-10
                    </span>{" "}
                    <span className="font-weight-bold">₹3,500</span>{" "}
                  </div>
                  <p className="card-text mb-1 mt-1">
                    Some quick example text to build on the card title and make
                    up the bulk of the card's content.
            ...
            <div className="col-md-4">
              <div className="card">
                {" "}
                <img
                  src="https://i.imgur.com/rdYgwhr.jpg"
                  className="card-img-top"
                />
                <div className="card-body">
                  <div className="d-flex justify-content-between">
            ...
            <div className="col-md-4">
              <div className="card">
                {" "}
                <img
                  src="https://i.imgur.com/x6hhqGn.jpg"
                  className="card-img-top"
                />
                <div className="card-body">
                  <div className="d-flex justify-content-between">
                    {" "}
                    <span className="font-weight-bold">
                      Luxury Dinning set-7
                    </span>{" "}
                    <span className="font-weight-bold">₹750</span>{" "}
                  </div>
                  <p className="card-text mb-1 mt-1">
                    Some quick example text to build on the card title and make
                    up the bulk of the card's content.
